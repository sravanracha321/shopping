   ...
   .then(product=>{
    ...
    return(
        <div className="container-fluid">
            <header className="d-flex justify-content-between p-3 bg-warning text-white" >
                <div>
                ...
                <div>
                    ...
                    <span className="me-3">Mens's Fashion</span>
                    <span className="me-3">Women's Fashion</span>
                </div>
                <div>
                    <button className="btn btn-light position-relative">
                        <span className="bi bi-cart4"></span>Your Cart 
                        <span className="badge rounded-circle bg-info position-absolute top-0 end-0">{cartCount}</span>
                    </button>
                </div>
            </header>
                                 ...
                                 <div className="card-body">
                                   <dl>
                                    ...
                                    <div className="card-footer">
                                     <button value={product.id} onClick={handleAddToCartClick}className="btn btn-success w-100">
